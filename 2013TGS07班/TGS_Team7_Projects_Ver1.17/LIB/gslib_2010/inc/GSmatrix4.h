...
GSINLINE GSmatrix4& GSmatrix4::scale( GSfloat x, GSfloat y, GSfloat z )
{
	...
	gsMatrix4Multiply( this, &s.setScale( x, y, z ), this );
...
GSINLINE GSmatrix4& GSmatrix4::rotate( GSfloat angle, GSfloat axisX, GSfloat axisY, GSfloat axisZ )
{
	...
	gsMatrix4Multiply( this, &r.setRotation( angle, axisX, axisY, axisZ ), this );
...
GSINLINE GSmatrix4& GSmatrix4::rotate( const GSquaternion& q )
{
	...
	gsMatrix4Multiply( this, &r.setRotation( q ), this );
...
GSINLINE GSmatrix4& GSmatrix4::rotateX( GSfloat angle )
{
	...
	gsMatrix4Multiply( this, &r.setRotationX( angle ), this );
...
GSINLINE GSmatrix4& GSmatrix4::rotateY( GSfloat angle )
{
	...
	gsMatrix4Multiply( this, &r.setRotationY( angle ), this );
...
GSINLINE GSmatrix4& GSmatrix4::rotateZ( GSfloat angle )
{
	...
	gsMatrix4Multiply( this, &r.setRotationZ( angle ), this );
...
GSINLINE GSmatrix4& GSmatrix4::rotateYawPitchRoll( GSfloat yaw, GSfloat pitch, GSfloat roll )
{
	...
	gsMatrix4Multiply( this, &r.setRotationYawPitchRoll( yaw, pitch, roll ), this );
...
GSINLINE GSmatrix4& GSmatrix4::translate( GSfloat x, GSfloat y, GSfloat z )
{
	...
	gsMatrix4Multiply( this, &t.setTranslation( x, y, z ), this );
...
/* 座標変換 */
GSINLINE GSvector2 GSmatrix4::transform( const GSvector2& v ) const
{
	return GSvector2( v.x * m[0][0] + v.y * m[1][0] + m[3][0],
		v.x * m[0][1] + v.y * m[1][1] + m[3][1] );
}

GSINLINE GSvector3 GSmatrix4::transform( const GSvector3& v ) const
{
	GSvector3	result;

	gsVector3Transform( &result, &v, this );

	return	result;
}

GSINLINE GSvector4 GSmatrix4::transform( const GSvector4& v ) const
{
	GSvector4	result;

	gsVector4Transform( &result, &v, this );

	return	result;
}

GSINLINE GSvector2 GSmatrix4::transformCoord( const GSvector2& v ) const
{
	GSvector2	result;

	gsVector2TransformCoord( &result, &v, this );

	return	result;
}

GSINLINE GSvector3 GSmatrix4::transformCoord( const GSvector3& v ) const
{
	GSvector3	result;

	gsVector3TransformCoord( &result, &v, this );

	return	result;
}

GSINLINE GSvector4 GSmatrix4::transformCoord( const GSvector4& v ) const
{
	GSvector4	result;

	gsVector4TransformCoord( &result, &v, this );

	return	result;
}

GSINLINE GSvector3 GSmatrix4::transformNormal( const GSvector3& v ) const
{
	GSvector3	result;

	gsVector3TransformNormal( &result, &v, this );
