...
/// <summary>ａ，ｂ小さい方の値を求める</summary>
/// <param name="a">値1</param>
/// <param name="b">値2</param>
/// <returns>a,bの小さい値</returns>
#define	MIN( a, b )			( ( (a) < (b) ) ? (a) : (b) )

/// <summary>ａ，ｂ大きい方の値を求める</summary>
/// <param name="a">値1</param>
/// <param name="b">値2</param>
/// <returns>a,bの大きい値</returns>
#define	MAX( a , b )		( ( (a) > (b) ) ? (a) : (b) )

/* ａが正なら１，負なら－１，ゼロなら０を求める */
/// <summary>aが正なら1、負なら-1、ゼロなら0を求める.</summary>
/// <param name="a"></param>
...
#define	gsAtan( x, y )	( (GSfloat)gsDegreeNormalize( RAD_TO_DEG( atan2( x, y ) ) ) )

/// <summary>平方根を求める</summary>
/// <param name="x">平方根を求める値.</param>
