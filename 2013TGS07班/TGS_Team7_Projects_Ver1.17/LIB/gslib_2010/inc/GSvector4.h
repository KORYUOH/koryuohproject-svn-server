...
/* 線形補間を行う */
GSINLINE GSvector4 GSvector4::lerp( const GSvector4& V, GSfloat t ) const
{
	GSvector4	result;

	gsVector4Lerp( &result, this, &V, t );

	return result;
}

/* ２次補間を行う */
GSINLINE GSvector4 GSvector4::quadratic( const GSvector4& V2, const GSvector4& V3, GSfloat t ) const
{
	GSvector4	result;

	gsVcector3Quadratic( &result, this, &V2, &V3, t );
