...
/// 球体と球体の衝突判定.
/// </summary>
/// <param name="pCenter1">球体１の中心</param>
/// <param name="Radius1">球体１の半径</param>
/// <param name="pCenter2">球体２の中心</param>
/// <param name="Radius2">球体２の半径</param>
/// <returns>衝突していれば真、衝突していなければ偽を返す</returns>
extern GSboolean
...
/// 球体とレイの衝突判定.
/// </summary>
/// <param name="pCenter">球体の中心座標</param>
/// <param name="Radius">球体の半径</param>
/// <param name="pRayPos">レイの位置</param>
/// <param name="pRayDir">レイの方向</param>
/// <param name="pIntersect">レイとの交点</param>
/// <returns>レイと球体が衝突していれば真，衝突していなければ偽を返す</returns>
extern GSboolean
...
/// <param name="pCenter">球体の中心座標</param>
/// <param name="Radius">球体の半径</param>
/// <param name="pRayPos">線分の始点</param>
/// <param name="pRayDir">線分の終点</param>
/// <param name="pIntersect">線分との交点</param>
/// <returns>球体と球体が衝突していれば真，衝突していなければ偽を返す</returns>
extern GSboolean
