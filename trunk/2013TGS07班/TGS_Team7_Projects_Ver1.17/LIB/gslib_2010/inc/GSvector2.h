...
extern "C" {
	...
	*============================================================================*/
	...
	{
		pOut->x = gsSin( Direction );
		pOut->y = gsCos( Direction );
...
/* 線形補間を行う */
GSINLINE GSvector2 GSvector2::lerp( const GSvector2& V, GSfloat t ) const
{
	GSvector2	result;

	gsVector2Lerp( &result, this, &V, t );

	return result;
}

/* ２次補間を行う */
GSINLINE GSvector2 GSvector2::quadratic( const GSvector2& V2, const GSvector2& V3, GSfloat t ) const
{
	GSvector2	result;

	gsVector2Quadratic( &result, this, &V2, &V3, t );
