...
/// <summary>カラー書き込みバッファをクリアする．</summary>
...
/// <summary>表面カリング.</summary>
#define GL_FRONT                          0x0404
/// <summary>裏面カリング.</summary>
#define GL_BACK                           0x0405
#define GL_LEFT                           0x0406
#define GL_RIGHT                          0x0407
/// <summary>両面カリング.</summary>
...
/// <summary>ライト処理.</summary>
#define GL_LIGHTING                       0x0B50
#define GL_LIGHT_MODEL_LOCAL_VIEWER       0x0B51
#define GL_LIGHT_MODEL_TWO_SIDE           0x0B52
/// <summary>ワールド全体の環境光RGBA 輝度.</summary>
#define GL_LIGHT_MODEL_AMBIENT            0x0B53
#define GL_SHADE_MODEL                    0x0B54
#define GL_COLOR_MATERIAL_FACE            0x0B55
#define GL_COLOR_MATERIAL_PARAMETER       0x0B56
#define GL_COLOR_MATERIAL                 0x0B57
/// <summary>フォグ処理.</summary>
#define GL_FOG                            0x0B60
#define GL_FOG_INDEX                      0x0B61
#define GL_FOG_DENSITY                    0x0B62
#define GL_FOG_START                      0x0B63
#define GL_FOG_END                        0x0B64
/// <summary>フォグのモードを設定.</summary>
#define GL_FOG_MODE                       0x0B65
#define GL_FOG_COLOR                      0x0B66
#define GL_DEPTH_RANGE                    0x0B70
/// <summary>Zバッファ.</summary>
...
/// <summary>赤成分のカラーパレット.</summary>
#define GL_PIXEL_MAP_I_TO_R               0x0C72
/// <summary>緑成分のカラーパレット.</summary>
#define GL_PIXEL_MAP_I_TO_G               0x0C73
/// <summary>青成分のカラーパレット.</summary>
#define GL_PIXEL_MAP_I_TO_B               0x0C74
/// <summary>アルファ成分のカラーパレット.</summary>
...
/// <summary>カラーパレットからのピクセル変換</summary>
...
/// <summary>鏡面反射光.</summary>
#define GL_SPECULAR                       0x1202
/// <summary>ライトの位置.</summary>
#define GL_POSITION                       0x1203
/// <summary>スポットライトの方向.</summary>
#define GL_SPOT_DIRECTION                 0x1204
/// <summary>スポットライト指数.</summary>
#define GL_SPOT_EXPONENT                  0x1205
/// <summary>スポットのカットオフ指数 (角度で指定).</summary>
...
/* MaterialParameter */
/// <summary>放射光カラー(自分が発光する場合の色).</summary>
#define GL_EMISSION                       0x1600
/// <summary>鏡面反射指数 (ハイライトの大きさ).</summary>
...
/* MatrixMode */
/// <summary>モデルビュー行列.</summary>
#define GL_MODELVIEW                      0x1700
/// <summary>射影変換行列.</summary>
...
/* ShadingModel */
/// <summary>フラットシェーディング.</summary>
#define GL_FLAT                           0x1D00
/// <summary>スムースシェーディング.</summary>
...
/// <summary>拡大時のフィルタ指定.</summary>
#define GL_TEXTURE_MAG_FILTER             0x2800
/// <summary>縮小時のフィルタ指定.</summary>
#define GL_TEXTURE_MIN_FILTER             0x2801
/// <summary>s座標のラップ指定.</summary>
#define GL_TEXTURE_WRAP_S                 0x2802
/// <summary>t座標のラップ指定.</summary>
...
/* TextureWrapMode */
/// <summary>クランプしてラップする.</summary>
#define GL_CLAMP                          0x2900
/// <summary>繰り返してラップする.</summary>
...
/// <summary>引数で指定したプリミティブの設定を開始する.</summary>
/// <param name="mode">プリミティブのタイプ.</param>
...
/// <summary>OpenGL用ウィンドウ内の画面を全て消去する.</summary>
/// <param name="mask">クリアするバッファを指定する.</param>
WINGDIAPI void APIENTRY glClear (GLbitfield mask);
WINGDIAPI void APIENTRY glClearAccum (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
/// <summary>画面消去時のカラーの設定をする.</summary>
/// <param name="red">赤色の成分 ( 0.0f ～ 1.0f ).</param>
/// <param name="green">緑色の成分 ( 0.0f ～ 1.0f ).</param>
/// <param name="blue">青色の成分 ( 0.0f ～ 1.0f ).</param>
/// <param name="alpha">アルファ成分（透明度） ( 0.0f ～ 1.0f ).</param>
...
/// <summary>プリミティブの頂点カラーの設定をする.</summary>
/// <code>0.0f が一番暗く，1.0f が一番明るい.</code>
/// <param name="red">赤色の成分 ( 0.0f ～ 1.0f )</param>
/// <param name="green">緑色の成分 ( 0.0f ～ 1.0f )</param>
/// <param name="blue">青色の成分 ( 0.0f ～ 1.0f )</param>
/// <param name="alpha">アルファ成分（透明度） ( 0.0f ～ 1.0f )</param>
...
/// <summary>面カリングのモードを設定する.</summary>
/// <param name="mode">カリングする面の指定</param>
...
/// <summary>OpenGLの様々な機能を無効にする.</summary>
/// <param name="cap">特定機能に対するシンボル定数を指定</param>
...
/// <summary>OpenGLの様々な機能を有効にする.</summary>
/// <param name="cap">特定機能に対するシンボル定数を指定</param>
WINGDIAPI void APIENTRY glEnable (GLenum cap);
WINGDIAPI void APIENTRY glEnableClientState (GLenum array);
/// <summary>glBegin から開始したプリミティブの設定を終了する.</summary>
...
/// <summary>設定済みの描画プリミティブを全て描画する.</summary>
WINGDIAPI void APIENTRY glFlush (void);
/// <summary>フォグのパラメータを設定する.</summary>
/// <param name="pname">フォグのパラメータ名</param>
/// <param name="param">フォグのパラメータ</param>
WINGDIAPI void APIENTRY glFogf (GLenum pname, GLfloat param);
/// <summary>フォグのカラーを設定する.</summary>
/// <param name="pname">フォグのパラメータ名</param>
/// <param name="param">フォグのカラー(ＲＧＢＡ)</param>
WINGDIAPI void APIENTRY glFogfv (GLenum pname, const GLfloat *params);
/// <summary>フォグのモードを設定する.</summary>
/// <param name="pname">フォグのパラメータ名</param>
/// <param name="param">フォグのモード</param>
...
/// <summary>照明モデルの設定を行う.</summary>
/// <param name="pname">照明モデルのパラメータ名</param>
/// <param name="params">ライトのカラー</param>
WINGDIAPI void APIENTRY glLightModelfv (GLenum pname, const GLfloat *params);
WINGDIAPI void APIENTRY glLightModeli (GLenum pname, GLint param);
WINGDIAPI void APIENTRY glLightModeliv (GLenum pname, const GLint *params);
/// <summary>ライトの設定.</summary>
/// <param name="light">ライトの番号 ( GL_LIGHT0 ～ GL_LIGHT7 )</param>
/// <param name="pname">設定したいライトのパラメータ</param>
/// <param name="param">各種パラメータ.</param>
WINGDIAPI void APIENTRY glLightf (GLenum light, GLenum pname, GLfloat param);
/// <summary>ライトの設定.</summary>
/// <param name="light">ライトの番号 ( GL_LIGHT0 ～ GL_LIGHT7 )</param>
/// <param name="pname">設定したいライトのパラメータ</param>
/// <param name="params">各種パラメータ.
/// <para>ディレクショナルライト(平行光源) : 4番目のパラメータを0.0fに設定</para>
/// <para>ポイントライト : 4番目のパラメータを1.0fに設定</para>
/// <para>スポットライト : カットオフ指数 or スポットライト指数</para>
/// </param>
...
/// <summary>現在設定中の変換行列を単位行列にする.</summary>
...
/// <summary>マテリアルの設定をする.</summary>
/// <param name="face">設定する面を指定する</param>
/// <param name="pname">設定するパラメータを指定する</param>
/// <param name="params">鏡面反射指数</param>
WINGDIAPI void APIENTRY glMaterialf (GLenum face, GLenum pname, GLfloat param);
/// <summary>マテリアルの設定をする.</summary>
/// <param name="face">設定する面を指定する</param>
/// <param name="pname">設定するパラメータを指定する</param>
/// <param name="params">RGBA カラー</param>
WINGDIAPI void APIENTRY glMaterialfv (GLenum face, GLenum pname, const GLfloat *params);
WINGDIAPI void APIENTRY glMateriali (GLenum face, GLenum pname, GLint param);
WINGDIAPI void APIENTRY glMaterialiv (GLenum face, GLenum pname, const GLint *params);
/// <summary>設定する変換行列のタイプを設定.</summary>
/// <param name="mode">変換行列のタイプ</param>
...
/// <summary>法線ベクトルの設定を行う.</summary>
/// <param name="nx">法線ベクトルのx成分</param>
/// <param name="ny">法線ベクトルのy成分</param>
/// <param name="nz">法線ベクトルのz成分</param>
...
/// <summary>カラーパレットの設定をする.</summary>
/// <param name="map">カラー要素の指定</param>
/// <param name="mapsize">定義するカラー成分の要素数</param>
/// <param name="values">カラー成分</param>
...
/// <summary>ピクセル変換モードの設定をする.</summary>
/// <param name="pname">ピクセル変換モード名</param>
/// <param name="pname">パラメータ
...
/// <summary>回転行列を設定する.</summary>
/// <param name="angle">回転角度</param>
/// <param name="x">回転軸ベクトルのｘ成分</param>
/// <param name="y">回転軸ベクトルのｙ成分</param>
/// <param name="z">回転軸ベクトルのｚ成分</param>
WINGDIAPI void APIENTRY glRotatef (GLfloat angle, GLfloat x, GLfloat y, GLfloat z);
WINGDIAPI void APIENTRY glScaled (GLdouble x, GLdouble y, GLdouble z);
/// <summary>拡大縮小行列を設定する.</summary>
/// <param name="x">ｘ軸方向への拡大縮小率</param>
/// <param name="y">ｙ軸方向への拡大縮小率</param>
/// <param name="z">ｚ軸方向への拡大縮小率</param>
WINGDIAPI void APIENTRY glScalef (GLfloat x, GLfloat y, GLfloat z);
WINGDIAPI void APIENTRY glScissor (GLint x, GLint y, GLsizei width, GLsizei height);
WINGDIAPI void APIENTRY glSelectBuffer (GLsizei size, GLuint *buffer);
/// <summary>シェーディング方法の指定を行う.</summary>
/// <param name="mode">シェーディングモード</param>
...
/// <summary>頂点にテクスチャ座標の設定をする.</summary>
/// <param name="s">ｓ座標．(x方向の座標)</param>
/// <param name="t">ｔ座標．(y方向の座標)</param>
...
/// <summary>頂点にテクスチャ座標の設定をする.</summary>
/// <param name="target">ターゲットテクスチャの指定( 通常はGL_TEXTURE_2D )</param>
/// <param name="level">ミップマップレベル ( 通常は０ )</param>
/// <param name="internalformat">カラー要素の数( RGB なら３，RGBA なら４ )</param>
/// <param name="width">テスチャイメージの幅(２のｎ乗)</param>
/// <param name="height">テクスチャイメージの高さ(２のｎ乗)</param>
/// <param name="border">テクスチャの縁(０または１)</param>
/// <param name="format">テクスチャイメージのフォーマット</param>
/// <param name="type">ピクセルデータのデータ形式</param>
/// <param name="pixels">ピクセルデータ</param>
WINGDIAPI void APIENTRY glTexImage2D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
WINGDIAPI void APIENTRY glTexParameterf (GLenum target, GLenum pname, GLfloat param);
WINGDIAPI void APIENTRY glTexParameterfv (GLenum target, GLenum pname, const GLfloat *params);
/// <summary>テクスチャの各種パラメータの設定をする.</summary>
/// <param name="target">ターゲットテクスチャの指定</param>
/// <param name="pname">設定したいパラメータの名前</param>
/// <param name="param">パラメータの値</param>
WINGDIAPI void APIENTRY glTexParameteri (GLenum target, GLenum pname, GLint param);
WINGDIAPI void APIENTRY glTexParameteriv (GLenum target, GLenum pname, const GLint *params);
WINGDIAPI void APIENTRY glTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels);
WINGDIAPI void APIENTRY glTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);
WINGDIAPI void APIENTRY glTranslated (GLdouble x, GLdouble y, GLdouble z);
/// <summary>平行移動行列を設定する.</summary>
...
/// <summary>glBegin から開始したプリミティブの頂点座標の設定をする.</summary>
/// <param name="x">頂点のｘ座標</param>
/// <param name="y">頂点のy 座標</param>
/// <param name="z">頂点のz 座標</param>
...
/// <summary>ビューポートを設定する.</summary>
/// <param name="x">ビューポートのｘ座標</param>
/// <param name="y">ビューポートのｙ座標</param>
