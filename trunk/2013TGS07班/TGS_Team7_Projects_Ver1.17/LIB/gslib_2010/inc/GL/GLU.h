...
/// <summary>透視射影変換行列を設定する.</summary>
/// <param name="fovy">視野角</param>
/// <param name="aspect">ビューポートの縦横比(幅÷高)</param>
/// <param name="zNear">近クリップ面の位置 (近クリップ面より前は表示されない)</param>
/// <param name="zFar">遠クリップ面の位置 (遠クリップ面より奥は表示されない)</param>
...
/// 視界変換行列を設定する.
/// </summary>
/// <param name="eyex">視点のX座標の位置</param>
/// <param name="eyey">視点のY座標の位置</param>
/// <param name="eyez">視点のZ座標の位置</param>
/// <param name="centerx">注視点のX座標</param>
/// <param name="centery">注視点のX座標</param>
/// <param name="centerz">注視点のX座標</param>
/// <param name="upx">視点の上の方向のxベクトル</param>
/// <param name="upy">視点の上の方向のyベクトル</param>
/// <param name="upz">視点の上の方向のzベクトル</param>
