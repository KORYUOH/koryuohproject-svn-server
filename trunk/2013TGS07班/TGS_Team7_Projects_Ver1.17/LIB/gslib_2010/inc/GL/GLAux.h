...
/// <summary>OpenGL用ウィンドウの画面モードを設定する.</summary>
/// <param name="mode">画面モード</param>
void APIENTRY auxInitDisplayMode(GLenum);
/// <summary>OpenGL用ウィンドウの位置とサイズを設定する.</summary>
/// <param name="x">ウィンドウのｘ座標</param>
/// <param name="y">ウィンドウのｙ座標</param>
...
#ifdef UNICODE
/// <summary>OpenGL用ウィンドウをオープンする.</summary>
...
/// <summary>ダブルバッファの切り替えを行う.</summary>
