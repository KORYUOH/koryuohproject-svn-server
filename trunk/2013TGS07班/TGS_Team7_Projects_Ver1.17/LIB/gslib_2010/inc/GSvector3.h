...
/* ２次補間を行う */
GSINLINE GSvector3 GSvector3::quadratic( const GSvector3& V2, const GSvector3& V3, GSfloat t ) const
{
	GSvector3	result;

	gsVector3Quadratic( &result, this, &V2, &V3, t );
