...
GSINLINE GSmatrix3& GSmatrix3::scale( GSfloat x, GSfloat y, GSfloat z )
{
	...
	gsMatrix3Multiply( this, &s.setScale( x, y, z ), this );
...
GSINLINE GSmatrix3& GSmatrix3::rotate( GSfloat angle, GSfloat axisX, GSfloat axisY, GSfloat axisZ )
{
	...
	gsMatrix3Multiply( this, &r.setRotation( angle, axisX, axisY, axisZ ), this );
...
GSINLINE GSmatrix3& GSmatrix3::rotate( const GSquaternion& q )
{
	...
	gsMatrix3Multiply( this, &r.setRotation( q ), this );
...
GSINLINE GSmatrix3& GSmatrix3::rotateX( GSfloat angle )
{
	...
	gsMatrix3Multiply( this, &r.setRotationX( angle ), this );
...
GSINLINE GSmatrix3& GSmatrix3::rotateY( GSfloat angle )
{
	...
	gsMatrix3Multiply( this, &r.setRotationY( angle ), this );
...
GSINLINE GSmatrix3& GSmatrix3::rotateZ( GSfloat angle )
{
	...
	gsMatrix3Multiply( this, &r.setRotationZ( angle ), this );
...
GSINLINE GSmatrix3& GSmatrix3::rotateYawPitchRoll( GSfloat yaw, GSfloat pitch, GSfloat roll )
{
	...
	gsMatrix3Multiply( this, &r.setRotationYawPitchRoll( yaw, pitch, roll ), this );
...
GSINLINE GSmatrix3& GSmatrix3::translate( GSfloat x, GSfloat y )
{
	...
	gsMatrix3Multiply( this, &t.setTranslation( x, y ), this );
...
/* 座標変換 */
GSINLINE GSvector2 GSmatrix3::transform( const GSvector2& v ) const
{
	GSvector2	result;

	gsVector2Transform( &result, &v, this );

	return	result;
}

GSINLINE GSvector3 GSmatrix3::transform( const GSvector3& v ) const
{
	GSvector3	result;
...
GSINLINE GSvector2 GSmatrix3::transformNormal( const GSvector2& v ) const
{
	GSvector2	result;

	gsVector2TransformNormal( &result, &v, this );
